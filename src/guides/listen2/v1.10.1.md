...
To manage your documents, swipe left on any row to delete it. Press and hold on a document to bring up a context menu with more options — from there you can **rename** the document, **add it to a collection**, or **export the plain text**.
...
To delete a voice, swipe left on it in the Voice Library. The bundled voice cannot be removed — it is your safety net.
