...
<p>When you open a document with VoiceOver active, focus lands directly on the reading content — not the toolbar. All chrome buttons (top bar and bottom bar) are fully tappable and explorable by touch from their on-screen positions.</p>
...
When VoiceOver is active, the top and bottom bars stay visible at all times. Auto-scrolling is disabled so the text does not move under your focus. The "Jump to Playback Position" button (the crosshairs icon in the top bar) brings the current reading line back into view.
