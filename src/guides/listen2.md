...
<h4>{% icon "clipboard", "inline-icon" %} Clipboard Magic</h4>
...
<div class="tip-box">
<h4>{% icon "lightbulb", "inline-icon" %} Pro Tip</h4>
...
<div class="feature-box">
<h4>{% icon "zap", "inline-icon" %} Automatic Optimization</h4>
...
<div class="tip-box">
<h4>{% icon "lightbulb", "inline-icon" %} When to Use Each Level</h4>
<ul>
...
<div class="tip-box">
<h4>{% icon "lightbulb", "inline-icon" %} Voice Selection Tip</h4>
