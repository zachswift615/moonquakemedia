...
<div class="tip-box">
<h4>{% icon "lightbulb", "inline-icon" %} First Time Tip</h4>
...
<h4>{% icon "music", "inline-icon" %} Smart Lyrics Search</h4>
...
<div class="tip-box">
<h4>{% icon "lightbulb", "inline-icon" %} Pro Tip: Formatting Lyrics</h4>
...
<div class="feature-box">
<h4>{% icon "theater", "inline-icon" %} Use Cases for Setlists</h4>
<ul>
...
<div class="feature-box">
<h4>{% icon "gamepad-2", "inline-icon" %} Control Panel</h4>
<ul>
...
<li><strong>[{% icon "save", "inline-icon-sm" %}] Save</strong> - Save current scroll speed as default for this song</li>
...
- Tap the **{% icon "save", "inline-icon-sm" %}** button to save your preferred speed for this song
...
<div class="tip-box">
<h4>{% icon "lightbulb", "inline-icon" %} Performance Tips</h4>
<ul>
...
<div class="warning-box">
<h4>{% icon "alert-triangle", "inline-icon" %} Battery Management</h4>
...
<div class="feature-box">
<h4>{% icon "palette", "inline-icon" %} Available Themes</h4>
<ul>
...
<div class="tip-box">
<h4>{% icon "lightbulb", "inline-icon" %} Finding Your Perfect Size</h4>
...
3. Tap the {% icon "save", "inline-icon-sm" %} button to save that speed for this song
...
<div class="feature-box">
<h4>{% icon "package", "inline-icon" %} What Gets Exported</h4>
...
<div class="tip-box">
<h4>{% icon "lightbulb", "inline-icon" %} Backup Best Practices</h4>
<ul>
...
<div class="feature-box">
<h4>{% icon "sparkles", "inline-icon" %} GigScroll Pro Benefits</h4>
<ul>
...
1. Go to **Settings**
2. Tap **{% icon "star", "inline-icon-sm" %} Upgrade to Pro** at the top
...
- **Save speeds per song** - Use the {% icon "save", "inline-icon-sm" %} button after you find the perfect speed

<div class="tip-box">
<h4>{% icon "lightbulb", "inline-icon" %} Pro Musician Tip</h4>
...
- Remember to tap the {% icon "save", "inline-icon-sm" %} button to save your preferred speed
