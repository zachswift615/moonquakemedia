...
1. **Welcome to GigScroll** — An introduction to the app
2. **Find Your Lyrics** — How to search online or add songs manually
3. **Build Setlists** — How to organize songs for your performances
4. **Perform with Confidence** — How auto-scrolling works and how to control the pace
5. **Record Your Performances** — How to capture video while you perform
6. **Customize Your Font** — How to change font size for all songs or new songs only
7. **Choose Your Theme** — How to select a theme for stage visibility

You can move through the tutorial by tapping <span class="button-label">Next</span> on each page. On the final page, tap <span class="button-label">Get Started</span> to enter the app. You may also tap <span class="button-label">Skip</span> at any time to go directly to the main screen.

If you want to view the tutorial again later, go to **Settings** and tap <span class="button-label">Show Tutorial Again</span>.
...
<div class="feature-box"><h4>{% icon "music", "inline-icon" %} Songs</h4><p>Your complete song library. Browse all saved songs, search by title or artist, and add new songs. Tap any song to view or edit its lyrics.</p></div>

<div class="feature-box"><h4>{% icon "list", "inline-icon" %} Setlists</h4><p>Organized collections of songs for your performances. Create a setlist for each gig, arrange the song order, and move through songs during a live show.</p></div>

<div class="feature-box"><h4>{% icon "settings", "inline-icon" %} Settings</h4><p>Configure themes, fonts, video recording, data management, foot pedal support, and more. This is also where you can view the tutorial again.</p></div>

<div class="tip-box"><h4>{% icon "lightbulb", "inline-icon" %} Getting Started Quickly</h4><p>Start by opening the Songs tab and exploring the 8 sample songs. Tap a song, then tap the play button to see how auto-scrolling works. Once you are comfortable, add 5 to 10 of your most-performed songs. This will give you a useful library right away.</p></div>
...
2. Tap the <span class="button-label">+</span> button in the top-right corner.
3. Enter a song title or artist name. As you type, autocomplete suggestions appear below the search bar.

<div class="feature-box"><h4>{% icon "zap", "inline-icon" %} Instant Lyrics Indicator</h4><p>Some suggestions display a bolt icon next to the title. This icon means that lyrics are available for immediate download. Songs without the bolt icon may still have lyrics, but retrieval may take longer.</p></div>

4. Tap a suggestion. GigScroll searches multiple lyrics databases automatically. If the first source does not have the lyrics, GigScroll tries the next source without any action from you.
5. When lyrics are found, review them and tap <span class="button-label">Save</span>.

<div class="tip-box"><h4>{% icon "lightbulb", "inline-icon" %} Duplicate Detection</h4><p>If a song with the same title and artist already exists in your library, GigScroll will notify you and will not create a duplicate.</p></div>

### 2.2 Adding Songs — Manual Entry

1. Tap the <span class="button-label">+</span> button in the top-right corner.
2. Enter the song title. This field is required.
3. Enter the artist name. This field is optional.
4. Type or paste your lyrics into the editor.
5. Tap <span class="button-label">Save</span>. All changes save automatically after creation.
...
- <span class="button-label">✕</span> — Close the editor and return to the library.
- <span class="button-label">Trash</span> — Delete the song. A confirmation prompt appears before deletion.
- <span class="button-label">Speed</span> — Displays the current scroll speed. Tap to open a jog wheel control where you can adjust the teleprompter speed for this song.
- <span class="button-label">Font Size</span> — Displays the current font size in points. Tap to open a jog wheel control where you can adjust the text size for this song.
...
1. In the Songs tab, swipe left on the song you want to remove.
2. Tap <span class="button-label">Delete</span>.

<div class="warning-box"><h4>{% icon "alert-triangle", "inline-icon" %} Permanent Action</h4><p>Deleting a song removes it from all setlists that contain it. This action cannot be undone unless you have a backup. To protect your library, consider exporting your data regularly.</p></div>
...
1. Open the <span class="button-label">Setlists</span> tab.
2. Tap the <span class="button-label">+</span> button.
3. Enter a name for the setlist.
...
1. Open the setlist you want to edit.
2. Tap the <span class="button-label">+</span> button in the top-right corner.
3. A list of songs from your library appears. Songs that are already in the setlist are excluded from this list.
4. Tap a song to add it.
...
1. Open the setlist.
2. Tap <span class="button-label">Edit</span> in the top-left corner.
3. Drag songs up or down using the handle on the right side of each row.
4. Tap <span class="button-label">Done</span> when you are satisfied with the order.

### 3.4 Removing Songs from a Setlist

1. Swipe left on any song in the setlist.
2. Tap <span class="button-label">Delete</span>.
...
1. Open the <span class="button-label">Setlists</span> tab.
2. Swipe left on the setlist you want to delete.
3. Tap <span class="button-label">Delete</span>.

All songs in the deleted setlist remain in your library. No song data is lost.

### 3.6 Sharing a Setlist

1. Open the setlist you want to share.
2. Tap the <span class="button-label">Share</span> button (the square icon with an upward arrow).
3. Choose a sharing method: AirDrop, Messages, Email, Files, or any other available option.
...
<div class="tip-box"><h4>{% icon "lightbulb", "inline-icon" %} Sharing with Band Members</h4><p>Use the Share feature to send your setlist to other performers before a show. Each recipient receives the full setlist with all song lyrics included. No additional setup is required on their device.</p></div>
...
<ul>
<li><strong>Venue-specific</strong> — Create a setlist for each venue you perform at regularly.</li>
<li><strong>Genre-based</strong> — Group songs by genre, such as "Country Set" or "Jazz Standards."</li>
<li><strong>Event-based</strong> — Prepare setlists for specific occasions, such as weddings, corporate events, or open mic nights.</li>
<li><strong>Seasonal</strong> — Build setlists for holidays or seasonal performances.</li>
<li><strong>Practice</strong> — Assemble songs you are currently learning or rehearsing.</li>
</ul>
</div>
...
- **Single Song**: Open any song from the Songs tab. Tap the <span class="button-label">Play</span> button.
- **Full Setlist**: Open a setlist. Tap the green <span class="button-label">Play Setlist</span> button. All songs in the setlist will be available in order.
...
| Button | Description |
|--------|-------------|
| <span class="button-label">−</span> | Decrease scroll speed by one step. |
| <span class="button-label">Play / Pause</span> | Start or pause auto-scrolling. This is a large button with a yellow accent when using the Stage theme. |
| <span class="button-label">+</span> | Increase scroll speed by one step. |
| <span class="button-label">Previous Song</span> | Go to the previous song. Hidden if you are not in a setlist or if you are on the first song. |
| <span class="button-label">Next Song</span> | Go to the next song. Hidden if you are not in a setlist or if you are on the last song. |
| <span class="button-label">Speed</span> | Displays the current speed (for example, "1.2x") with a downward chevron. Tap to open the speed jog wheel. |

### 4.4 Speed Jog Wheel

<div class="feature-box"><h4>{% icon "sliders", "inline-icon" %} Precise Speed Control</h4><p>The speed jog wheel provides fine-grained control over scroll speed. It opens as a sheet on iPhone or as a popover on iPad. Drag vertically in portrait orientation or horizontally in landscape orientation to adjust speed. The speed range is <strong>0.2x</strong> to <strong>3.0x</strong>. The device provides haptic feedback at 0.05x and 0.1x intervals so you can feel each change. A stronger warning haptic plays when you reach the minimum or maximum limit.</p></div>

### 4.5 Auto-Scrolling

When you tap <span class="button-label">Play</span>, the lyrics scroll from bottom to top at the selected speed. Use the <span class="button-label">+</span> and <span class="button-label">−</span> buttons for quick adjustments. Open the speed jog wheel for precise control.
...
When performing a full setlist, use the <span class="button-label">Next Song</span> and <span class="button-label">Previous Song</span> buttons to move between songs. The position indicator in the header shows your current position (for example, "2/5").

### 4.9 Exiting Performance Mode

Tap the <span class="button-label">Back</span> button or the <span class="button-label">Done</span> button in the top corner of the screen to leave Performance Mode and return to the previous screen.

<div class="tip-box"><h4>{% icon "lightbulb", "inline-icon" %} Test Your Settings Before the Show</h4><p>Run through at least one song in Performance Mode before your live performance. Adjust scroll speed until it matches your singing pace. If you perform under bright stage lights, enable the <strong>Stage</strong> theme in Settings for high-contrast visibility.</p></div>

<div class="warning-box"><h4>{% icon "alert-triangle", "inline-icon" %} Battery Management</h4><p>Performance Mode keeps the screen awake at full brightness for the entire duration of your set. This uses significant battery power. Charge your iPad fully before each performance. For long sets (90 minutes or more), connect your device to a power source.</p></div>

</div>

<div class="content-section" id="video-recording">
...
2. Find the **Video Recording** section.
3. Turn on the <span class="button-label">Enable Video Recording</span> toggle.
...
**Default Camera**
Choose between **Front** or **Rear** camera.

**Default Quality**
The available quality options depend on your device hardware:
...
**Default Flash**
Choose **Off**, **On**, or **Auto**. The default setting is Off.

**Audio Input**
This setting lists all available audio sources on your device. Sources may include:
...
**Top Bar**
- <span class="button-label">Close</span> — Closes the camera preview.
- <span class="button-label">Minimize</span> — Shrinks the preview to a draggable thumbnail.
- **Flash toggle** (bolt icon) — Turns the flash on or off. The icon turns yellow when flash is active.
- <span class="button-label">Flip Camera</span> — Switches between the front and rear camera.
- **Quality selector** — Changes the video quality for the current session.

**Lens Selector**
On devices with multiple rear camera lenses, a frosted glass control appears showing available zoom options (for example: 0.5x, 1x, 2x, 5x). The exact options depend on your device camera hardware. This control does not appear on single-lens devices or when using the front camera.
...
Recording stops automatically and the video is saved if any of the following occur:
...
<div class="tip-box"><h4>{% icon "lightbulb", "inline-icon" %} Test Your Setup During Soundcheck</h4><p>Before your performance, open the camera preview and start a short test recording during soundcheck. Verify that the correct camera, audio source, and quality settings are selected. Delete the test video afterward.</p></div>

<div class="warning-box"><h4>{% icon "alert-triangle", "inline-icon" %} Free Tier Recording Limit</h4><p>The free version of GigScroll includes a limit of 20 video recordings. After you reach this limit, you must upgrade to GigScroll Pro to continue recording. Recordings already saved to your Photos library are not affected.</p></div>
...
1. Open your iPad's **Settings** app and go to **Bluetooth**.
2. Turn on your foot pedal or Bluetooth keyboard and place it in pairing mode.
3. Select the device from the list of available Bluetooth devices to complete pairing.
4. Open GigScroll and go to **Settings → Foot Pedal**.
5. Turn on the <span class="button-label">Enable Foot Pedal Controls</span> toggle.
6. Default key mappings are pre-configured and ready to use.

### 6.2 Available Actions

<div class="feature-box"><h4>{% icon "sliders", "inline-icon" %} Mappable Actions</h4><p>GigScroll provides five actions that you can assign to foot pedal buttons or keyboard keys:</p>
<ul>
<li><strong>Play / Pause</strong> — Start or stop auto-scrolling.</li>
<li><strong>Speed Up</strong> — Increase the scroll speed by 0.1x.</li>
<li><strong>Speed Down</strong> — Decrease the scroll speed by 0.1x.</li>
<li><strong>Next Song</strong> — Advance to the next song in the current setlist.</li>
<li><strong>Previous Song</strong> — Go back to the previous song in the current setlist.</li>
</ul>
</div>
...
1. Open GigScroll and go to **Settings → Foot Pedal**.
2. Confirm that the <span class="button-label">Enable Foot Pedal Controls</span> toggle is turned on.
3. Tap the action you want to remap.
4. The selected row highlights and displays the message **"Press a pedal button..."**.
5. Press the desired button on your foot pedal or Bluetooth keyboard.
6. The new key is assigned immediately. The row updates to show the new mapping.
...
To restore all key assignments to their original values, tap <span class="button-label">Reset to Defaults</span> at the bottom of the Foot Pedal settings screen.
...
<div class="tip-box"><h4>{% icon "lightbulb", "inline-icon" %} Test Before Your Performance</h4><p>Always test your foot pedal mappings before a live performance. Open a song in Performance Mode and verify that each button triggers the correct action. Remember that any Bluetooth keyboard works with this feature — a dedicated foot pedal is not required. If you also use a Bluetooth keyboard for typing in other parts of the app, turn off the toggle when you are not performing.</p></div>

<div class="warning-box"><h4>{% icon "alert-triangle", "inline-icon" %} Bluetooth Keyboard Conflict</h4><p>When foot pedal controls are enabled, all mapped keys are intercepted by GigScroll in Performance Mode. This means those keys will not function normally for typing or other input. If you use a Bluetooth keyboard for purposes other than foot pedal control, disable the toggle when you are not performing.</p></div>
...
<div class="feature-box"><h4>{% icon "palette", "inline-icon" %} Available Themes</h4>
<p><strong>Light</strong> — Black text on a white background. Suitable for practice sessions and well-lit venues.</p>
<p><strong>Dark</strong> — White text on a black background. Reduces eye strain in dim venues.</p>
<p><strong>Stage (High Contrast)</strong> — Bright yellow text on a black background with gold accents. Designed for maximum visibility under bright stage lights.</p>
<p><strong>Cream (Warm)</strong> — Dark brown text on a cream background with coffee brown accents. A warm, vintage-inspired appearance.</p>
</div>
...
<div class="tip-box"><h4>{% icon "lightbulb", "inline-icon" %} Recommended Font Sizes</h4>
<p><strong>24–32pt:</strong> Close reading, practice sessions, or smaller iPad screens.</p>
<p><strong>32–44pt:</strong> Standard performance use, with the iPad at arm's length.</p>
<p><strong>44–56pt:</strong> Large iPad Pro screens or standing performances.</p>
<p><strong>56–72pt:</strong> Maximum visibility for bright stages or viewing from a distance.</p>
</div>
...
1. Open the **Settings** tab.
2. Under **Data Management**, tap <span class="button-label">Export All Songs & Setlists</span>.
3. Choose a destination for the file. You may save it to the Files app, send it via AirDrop, attach it to an email, or upload it to a cloud storage service.

GigScroll creates a file named **GigScroll-Backup-YYYY-MM-DD.gigscroll**, where YYYY-MM-DD is the current date.

<div class="feature-box"><h4>{% icon "package", "inline-icon" %} What Gets Exported</h4><p>The export file includes:</p>
<ul>
<li><strong>All songs</strong> — title, artist, lyrics, font settings, and scroll speeds</li>
<li><strong>All setlists</strong> — including the order of songs within each setlist</li>
<li><strong>Your settings</strong> — theme, default font, and default font size</li>
</ul>
<p>The file uses JSON format with a <code>.gigscroll</code> extension.</p></div>
...
1. Open the **Settings** tab.
2. Under **Data Management**, tap <span class="button-label">Import from File</span>.
3. Select a `.gigscroll` or `.json` file from your device.
...
Before you tap <span class="button-label">Import</span>, choose one of three import strategies:
...
<div class="warning-box"><h4>{% icon "alert-triangle", "inline-icon" %} Free Tier Limit</h4><p>Free tier users have a limit of 20 songs. If the import would cause your library to exceed this limit, a warning appears. You may choose to upgrade to Pro or cancel the import.</p></div>
...
3. Choose a sharing method — AirDrop, email, Messages, or any other available option.
...
1. Open the **Settings** tab.
2. Tap <span class="button-label">Restore Purchases</span>.
3. Sign in with the same Apple ID that was used for the original purchase.

Your Pro features are restored immediately.

<div class="tip-box"><h4>{% icon "lightbulb", "inline-icon" %} Backup Best Practices</h4><p>Follow these guidelines to protect your library:</p>
<ul>
<li><strong>Export weekly</strong> while you are actively adding songs to your library.</li>
<li><strong>Save backups to cloud storage</strong> such as iCloud Drive or Google Drive. This protects your data if your device is lost or damaged.</li>
<li><strong>Create a backup before major performances.</strong> This ensures you can recover quickly if something goes wrong.</li>
<li><strong>Export before iOS updates or device changes.</strong> System updates can occasionally cause unexpected issues.</li>
<li><strong>Share setlists with bandmates</strong> so that every member of your group has the same song data and setlist order.</li>
</ul>
</div>
...
<div class="feature-box"><h4>{% icon "sparkles", "inline-icon" %} GigScroll Pro</h4>
<ul>
<li><strong>Unlimited Songs</strong> — Build a library of any size with no restrictions.</li>
<li><strong>Unlimited Video Recordings</strong> — Record as many performances as you need.</li>
<li><strong>Unlimited Setlists</strong> — Create as many setlists as you want for different shows and rehearsals.</li>
<li><strong>Unlimited Imports</strong> — Import any number of songs from backup files.</li>
<li><strong>Support Development</strong> — Your purchase helps fund new features and improvements.</li>
<li><strong>One-Time Purchase</strong> — Pay once. There is no subscription and no recurring charge.</li>
</ul>
</div>
...
1. Open the **Settings** tab.
2. Tap <span class="button-label">Upgrade to Pro</span> at the top of the screen.
3. The paywall screen appears with feature details and the price (fetched directly from the App Store).
4. Tap <span class="button-label">Unlock Pro</span> to begin the purchase.
5. Complete the purchase using Face ID, Touch ID, or your Apple ID password.
...
1. Open the **Settings** tab.
2. Tap <span class="button-label">Restore Purchases</span>.
3. The app contacts the App Store to verify your purchase.
4. Once verified, Pro status is restored automatically.
...
- Practice navigating between songs using the <span class="button-label">Next</span> and <span class="button-label">Previous</span> buttons before your performance.
...
<div class="tip-box"><h4>{% icon "lightbulb", "inline-icon" %} Create a Practice Setlist</h4><p>Before each performance, create a short practice setlist with two or three songs. Use it to test your scroll speeds, confirm your theme choice, and verify readability at your expected distance from the screen. This takes only a few minutes and helps you avoid surprises during the actual performance.</p></div>
...
- Verify that the file has a `.gigscroll` or `.json` extension.
- The file may be corrupted. Try exporting again from the original device.
...
<div class="warning-box"><h4>{% icon "alert-triangle", "inline-icon" %} Performance Backup</h4><p>As a precaution, export your setlist before every performance and keep a copy in the Files app. If the app encounters an issue during a show, you can reimport your setlist quickly.</p></div>
...
<div class="tip-box"><h4>{% icon "lightbulb", "inline-icon" %} Battery Planning</h4><p>A fully charged iPad typically lasts 3–4 hours in Performance Mode at full brightness. If your performance is longer, plan to charge the iPad during a break.</p></div>
